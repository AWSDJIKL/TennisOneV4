...
#         ########################
#         self.posembd = nn.Conv2d(in_channels, in_channels, 1, groups=in_channels)
#         ########################
#         if in_channels != out_channels:
#             self.down = nn.Sequential(
#                 nn.Conv2d(in_channels, out_channels, 1),
...
#         self.l1 = TCN_GCN_unit(2, 128, A, adaptive=adaptive)
#         self.l2 = TCN_GCN_unit(128, 128, A, adaptive=adaptive)
#         self.l3 = TCN_GCN_unit(128, 128, A, adaptive=adaptive)
#         self.l4 = TCN_GCN_unit(128, 128, A, adaptive=adaptive)
#         self.l5 = TCN_GCN_unit(128, 256, A,  stride=2, adaptive=adaptive)
#         self.l6 = TCN_GCN_unit(256, 256, A, adaptive=adaptive)
#         self.l7 = TCN_GCN_unit(256, 256, A, adaptive=adaptive)
#         self.l8 = TCN_GCN_unit(256, 256, A, stride=2, adaptive=adaptive)
...
#     def forward(self, x):
#         # print(x.shape)#torch.Size([64, 2, 5, 17, 1])
#         N, C, T, V, M = x.size()
